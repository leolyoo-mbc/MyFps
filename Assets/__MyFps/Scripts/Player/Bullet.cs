    ...
    public class Bullet : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            if (distance > 0)
            {
                ...
                {
                    // 내 몸(플레이어)과 부딪힌 게 아니라면 적중 처리
                    if (shooterRoot == null || hitInfo.collider.transform.root != shooterRoot)
                    {
        ...
        public void Init(Vector3 direction, float floatDamage, LayerMask hitLayer, GameObject hitImpactPrefab, Transform shooterRoot)
        {
            this.damage = floatDamage;
